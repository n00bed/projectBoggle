 ...
 * 5. When the new game is started, the wordlist from the last game is still on the display.(FIXED)
 * 
 * NOT DONE 
 ...
 * 
 * Fixes required:
 * 7. (FIXED)progress bar status not starting with start button click (FIXED) 
 * 8. (DONE)Figure out if the grid buttons can be created using 2D arrays. Last time we did that 
